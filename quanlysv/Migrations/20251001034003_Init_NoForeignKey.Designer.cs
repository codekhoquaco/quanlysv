...
namespace quanlysv.Migrations
{
    ...
    [Migration("20251001034003_Init_NoForeignKey")]
    partial class Init_NoForeignKey
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("quanlysv.Models.Class", b =>
                {
                    ...
                    b.HasOne("quanlysv.Models.Faculty", null)
                        .WithMany("Classes")
            ...
            modelBuilder.Entity("quanlysv.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("quanlysv.Models.Student", null)
                        .WithMany("Enrollments")
                    ...
                    b.HasOne("quanlysv.Models.Subject", null)
                        .WithMany("Enrollments")
            ...
            modelBuilder.Entity("quanlysv.Models.Grade", b =>
                {
                    ...
                    b.HasOne("quanlysv.Models.Enrollment", null)
                        .WithMany("Grades")
            ...
            modelBuilder.Entity("quanlysv.Models.Student", b =>
                {
                    ...
                    b.HasOne("quanlysv.Models.Class", null)
                        .WithMany("Students")
